...
{
    private SoundScriptable soundScriptableObject;
    private AudioSource audioEffects;
    private AudioSource backgroundMusic;

    public SoundService(SoundScriptable soundScriptableObject, AudioSource audioEffectSource, AudioSource bgMusicSource)
    {
